...
class Button:
    ...
    def is_clicked(self, mouse_pos, mouse_pressed):
        ...
        if clicked and sound_button:
            sound_button.play() # Phát tiếng click
        return clicked
...
# =======================================================
# 1. FIX LỖI THIẾU __init__ TRONG ShopScreen
# =======================================================
class ShopScreen:
    def __init__(self):
        self.next_state = None
...
# =======================================================
# 2. FIX LỖI THIẾU BIẾN quests TRONG QuestsScreen
# =======================================================
class QuestsScreen:
    def __init__(self, quests=None): # Đã thêm parameter quests để không bị lỗi lúc khởi tạo ở main.py
